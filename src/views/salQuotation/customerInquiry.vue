<template>
  <div id="customerInquiry">
    <div class="contentBox">
      ...
      <!-- stripe size="mini" height="650px" :max-height="clientHeight" -->
      <el-table
        ref="tableCus"
          ...
          <template scope="scope">
            <span v-for="(oper1,index) in oneOperation" :key="oper1.id">
              <span v-show="scope.row.checkedColumn">
                ...
                <button
                        v-if="oper1.operationCode==='canceltableM'"
                        :title="oper1.operationName"
                        @click="canceltable(scope.$index, scope.row)"
                        :id="oper1.operationCode"
                        class="quoCancel"
                >{{oper1.operationName}}</button>
                <button
        ...
        <el-table-column label="处理" width="170" align="center">
          <template scope="scope">
            <div v-for="(oper2,index) in oneOperation" :key="oper2.id">
              <el-button
                style="margin-bottom: 5px;"
                class="operSpanSend"
                v-if="oper2.operationCode==='sender'"
                :id="oper2.operationCode"
                size="small"
                @click="sender(scope.$index, scope.row)"
        ...
        <el-table-column width="200" label="其它" align="center">
          <template scope="scope">
