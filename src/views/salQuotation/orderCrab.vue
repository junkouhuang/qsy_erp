                ...
                <div class="searchCondition"><span class="index"></span> 搜索条件：</div>
                 <el-form class="condition" :model="ruleForm" ref="ruleForm" size="small" :inline="true">
                    <el-form-item  prop="orderNo">
                         <!-- <el-input placeholder="订单编号" v-model="ruleForm.orderNo" suffix-icon="el-icon-search" size="small" v-on:focus="focus()"></el-input>  -->
                        ...
                        placeholder="订单编号"
                        @select="handleSelect">
                        <i slot="suffix" class="el-input__icon el-icon-search" style="cursor:pointer" @click="searchTypeQuotation(ruleForm.orderNo)"></i>
                        </el-autocomplete>
                    </el-form-item>
...
<script>
export { default } from './orderCrabScript'
</script>
<style lang="less">
