    ...
    <div class="contentBox">
      ...
      >
                ...
                >
                  ...
                  <el-table-column label="操作" width="80" align="center">
                    <template scope="scope">
                      <span v-for="(oper11,index) in twoOperation" :key="oper11.id">
                        <span v-show="scope.row.checkedColumn">
                          <!-- <i class="el-icon-check" v-if="oper11.operationCode==='savetableD'" :title="oper11.operationName" @click.stop="savetableTwo(scope.$index, scope.row)"></i>
                          <i class="el-icon-close" v-if="oper11.operationCode==='canceltableD'" :title="oper11.operationName" @click.stop="canceltableTwo(scope.$index, scope.row)"></i>-->
                        ...
                        <span v-show="!scope.row.checkedColumn">
                          <!-- <i class="el-icon-edit-outline" v-if="oper11.operationCode==='editRow'" :title="oper11.operationName" @click.stop="editRowTwo(scope.$index, scope.row)"></i> -->
                          <!-- <i class="el-icon-delete" v-if="oper11.operationCode==='deleteRow'" :title="oper11.operationName" @click.stop="deleteRowTwo(scope.$index, scope.row)"></i> -->
        ...
        <el-table-column label="操作" width="100" align="center">
          <template scope="scope">
            <span v-if="scope.row.statusCode=='Q6'">
              <span v-for="(oper1,index) in oneOperation" :key="oper1.id">
                <span v-show="scope.row.checkedColumn">
                  <!-- <el-button class="operSpan" v-if="oper1.operationCode==='savetableM'" :title="oper1.operationName" :id="oper1.operationCode" size="small" @click="savetable(scope.$index, scope.row)">{{oper1.operationName}}</el-button>
                  <el-button class="operSpan" v-if="oper1.operationCode==='canceltableM'" :title="oper1.operationName" :id="oper1.operationCode" size="small" @click="canceltable(scope.$index, scope.row)">{{oper1.operationName}}</el-button>-->
                  <button
                    v-if="oper1.operationCode==='savetableM'"
                    :title="oper1.operationName"
                    @click="savetable(scope.$index, scope.row)"
                    :id="oper1.operationCode"
                    class="quoSave"
                  >{{oper1.operationName}}</button>
                  <button
                    v-if="oper1.operationCode==='addRow'"
                    :title="oper1.operationName"
                    :id="oper1.operationCode"
                    class="quoAddDisabled"
                  >{{oper1.operationName}}</button>
                  <button
                    v-if="oper1.operationCode==='copytable'"
                    :title="oper1.operationName"
                    :id="oper1.operationCode"
                    class="quoCopyDisabled"
                  >{{oper1.operationName}}</button>
                </span>
                <span v-show="!scope.row.checkedColumn">
                  <button
                  ...
                  <button
                    v-if="oper1.operationCode==='copytable'"
                    :title="oper1.operationName"
                    @click="copytable(scope.$index, scope.row)"
                    :id="oper1.operationCode"
                    class="quoCopy"
                  >{{oper1.operationName}}</button>
                  <button
                    v-if="oper1.operationCode==='update'"
                    :title="oper1.operationName"
                  ...
                  <!-- <el-button class="operSpan" v-if="oper1.operationCode==='update'" :title="oper1.operationName" :id="oper1.operationCode" size="small" @click="update(scope.$index, scope.row)">{{oper1.operationName}}</el-button> 
                    <el-button class="operSpan" v-if="oper1.operationCode==='addRow'" :title="oper1.operationName" :id="oper1.operationCode" size="small" @click="addRow(scope.$index, scope.row)">{{oper1.operationName}}</el-button>
                  <el-button class="operSpan" v-if="oper1.operationCode==='copytable'" :title="oper1.operationName" :id="oper1.operationCode" size="small" @click="copytable(scope.$index, scope.row)">{{oper1.operationName}}</el-button>-->
                </span>
              </span>
            </span>
            <span v-else>
          ...
          <template scope="scope">
            <span v-if="scope.row.statusCode=='Q6'">
              <div v-for="(oper2) in oneOperation" :key="oper2.id">
                ...
                <el-button
                  style="margin-bottom: 5px;"
                  class="operSpanProduct"
                  v-if="oper2.operationCode==='changedealno'"
                  :id="oper2.operationCode"
                  size="small"
                  @click="changedealnoClick(scope.$index, scope.row,'Q7')"
                >{{oper2.operationName}}</el-button>
                <!-- 生成报价单 -->
                <el-button
                  style="margin-bottom: 5px;"
                  class="operSpanProduct"
                  v-if="oper2.operationCode==='producequotation'"
                  :id="oper2.operationCode"
                  size="small"
                  @click="producequotation(scope.$index, scope.row)"
                >{{oper2.operationName}}</el-button>
                <!-- 转订单 -->
                <el-button
                  style="margin-bottom: 5px;"
                  class="operSpanProduct"
                  v-if="oper2.operationCode==='changeorder'"
                  :id="oper2.operationCode"
                  size="small"
                  @click="revisionOrder(scope.$index, scope.row,'Q8')"
                >{{oper2.operationName}}</el-button>
                <!-- 重新报价 -->
                <el-button
                  style="margin-bottom: 5px;"
                  class="operSpanProduct"
                  v-if="oper2.operationCode==='againquotation'"
                  :id="oper2.operationCode"
                  size="small"
                  @click="sender(scope.$index, scope.row,'Q4')"
                >{{oper2.operationName}}</el-button>
                <!-- 发送邮件 -->
                <el-button
                  style="margin-bottom: 5px;"
                  class="operSpanProduct"
                  v-if="oper2.operationCode==='sendmail'"
                  :id="oper2.operationCode"
                  size="small"
                  @click="sender(scope.$index, scope.row,'Q6')"
                >{{oper2.operationName}}</el-button>
              </div>
            </span>
            <span v-else></span>
