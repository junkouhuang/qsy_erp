<template>
  <div class="upload">
    ...
    <div id="ossfile2" v-show="flag"></div>
    <div id="container2">
      <!-- <p :id=msg2  href="javascript:void(0);" class='btn'  @mousedown="getsign"><img :src="imgUrl" alt="图片损坏"></p> -->
      <!-- <img :src="imgUrl" alt=""> -->
      <a id="postfiles2" href="javascript:void(0);" class='btn' v-show="flag">开始上传</a>
      <img :src="imgUrl" alt="暂无图片" :id='msg2' href="javascript:void(0);" class='btn'  @mousedown="getsign" />
    </div>
    <!--提示语-->
  ...
  export default {
    ...
    data() {
      return {
        ...
        imgUrl: require('../../assets/image/baojia_img.jpg'),
        resVaule: {}, // 请求返回的数据
        msg:'abc',
        msg2:'selectfiles_c',
    ...
    methods: {
      getsign () {
        this.msg2="iii_ccc"
        // this.imgUrl = require('../../assets/image/baojia_img.jpg')
        // console.log('触发了？')
            ...
            if (response.code === 0 && response.obj) {
              ...
              var uploader = new plupload.Uploader({
                ...
                filters: {
                  ...
                  max_file_size: '20mb', //最大只能上传100mb的文件
                ...
                init: {
                  ...
                  FileUploaded:  (up, file, info) =>{
                    ...
                    if (info.status == 200) {
                      ...
                      this.$forceUpdate
                      //将路径添加到
                      this.$emit('getOssUrlImg',ossPath,igsCanvasId,file,'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1551175656701&di=1ffd5ecd2282338e42b44b6ab71384fd&imgtype=0&src=http%3A%2F%2Fhbimg.b0.upaiyun.com%2Fbf745342987031e9387958409c512665db6513ab81bb-5M44D2_fw658');
