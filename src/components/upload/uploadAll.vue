<template>
  <div class="upload">
    ...
    <div id="ossfile1" v-show="flag"></div>
    <div id="container1">
      <p :id='msg23'  href="javascript:void(0);" class='btn'  @mousedown="getsign">一件上传附件</p>
      <a id="postfiles1" href="javascript:void(0);" class='btn' v-show="flag">开始上传</a>
    </div>
    <!--提示语-->
